...
class _Delegate extends SliverPersistentHeaderDelegate {
  const _Delegate({
    ...
    required this.trailingBottomButtons,
  ...
  bool shouldRebuild(covariant _Delegate oldDelegate) =>
      ...
      trailingTopButtons.length != oldDelegate.trailingTopButtons.length ||
      trailingBottomButtons.length != oldDelegate.trailingBottomButtons.length;
  ...
  Widget build(
    ...
    Widget body = Stack(
      ...
      children: [
        ...
        if (transition < 1 && trailingBottomButtons.isNotEmpty)
          Positioned(
            right: 0,
            top: topPadding + Theming.normalTapTarget,
            height: Theming.normalTapTarget,
            child: Row(
              children: [
