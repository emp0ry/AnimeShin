...
import 'package:animeshin/feature/staff/staff_header.dart';
...
import 'package:animeshin/feature/staff/staff_floating_actions.dart';
import 'package:animeshin/feature/staff/staff_characters_view.dart';
import 'package:animeshin/feature/staff/staff_overview_view.dart';
import 'package:animeshin/feature/staff/staff_provider.dart';
import 'package:animeshin/util/paged_controller.dart';
import 'package:animeshin/feature/staff/staff_roles_view.dart';
...
class _CompactViewState extends State<_CompactView>
  ...
  Widget build(BuildContext context) {
    ...
    final header = StaffHeader.withTabBar(
      id: widget.id,
      imageUrl: widget.imageUrl,
      staff: widget.staff.asData?.value,
      tabCtrl: _tabCtrl,
