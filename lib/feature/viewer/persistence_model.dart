...
class Options {
  ...
  factory Options.fromPersistenceMap(Map<dynamic, dynamic> map) => Options(
        ...
        ruTitle: map['ruTitle'] ?? false,
        anilibriaEpDub: map['anilibriaEpDub'] ?? false,
...
enum ImageQuality {
  ...
  // Character and staff images don't have an extraLarge variant.
  String get personValue => switch (this) {
        ImageQuality.veryHigh => ImageQuality.high.value,
        _ => value,
      };
}
